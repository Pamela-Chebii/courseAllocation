    ...
    <div class="row">
        <div class="col-3 bg-success">
            <ul class="nav flex-column">
                ...
                <li class="nav-item stylenav">
                    <a class="nav-link" href="lecturer_dashboard.php">
                        <i class="fa fa-dashboard fa-lg text-white"></i>
                        <span class="text-white">Lecturer Dashboard</span>

                    </a>
                </li>
                <hr>
                <li class="nav-item stylenav">
                    <a class="nav-link" href="read_staff.php">
                ...
                <hr>
                <li class="nav-item stylenav">
                    <a class="nav-link" href="read_programs.php">
                ...
                <hr>
                <li class="nav-item stylenav">
                    <a class="nav-link" href="read_unit.php">
                        <i class="fa fa-clone fa-lg text-white"></i>
                        <span class="text-white">Units</span>
                    </a>
                </li>
                <li class="nav-item stylenav">
                    <a class="nav-link" href="read_allocatedUnit.php">
                        <i class="fa fa-tasks fa-lg text-white"></i>
                        <span class="text-white">Selected Units</span>
                    </a>
                </li>
                <hr>
                <li class="nav-item stylenav">
