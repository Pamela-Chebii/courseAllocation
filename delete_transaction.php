...
if (isset($_POST["submit"]) and !empty($_POST["transactionId"])){
    ...
    if ($result){
        ...
        echo "<a class='btn btn-success col-md-4' href='transaction.php'>BACK</a>";
        echo "</div>";
        ...
        <div class="alert alert-warning">
            ...
            <form action="delete_transaction.php" method="post">
                ...
                <div class="p-2 text-center">
                    ...
                    <a href="transaction.php" class="btn btn-success col-md-3">NO</a>
                </div>
            </form>
