...
if (isset($_POST["submit"]) and !empty($_POST["staffId"])){
    ...
    if ($result){
        ...
        echo "<a class='btn btn-success col-md-4' href='staff.php'>BACK</a>";
        echo "</div>";
        ...
        <div class="alert alert-warning">
            ...
            <form action="delete_staff.php" method="post">
                ...
                <div class="p-2 text-center">
                    ...
                    <a href="staff.php" class="btn btn-success col-md-3">NO</a>
                </div>
            </form>
