...
if (isset($_POST["submit"]) and !empty($_POST["cohortId"])){

    $cohortId = $_POST["cohortId"];
    $sql = "DELETE FROM `cohort` WHERE cohortId=$cohortId";
    $result = mysqli_query($link, $sql);

    if ($result){
        echo "<div class='row m-2 text-center'>";
        echo "<p class='alert alert-danger'>Record deleted Successfully</p>";
        echo "<a class='btn btn-warning col-md-4' href='cohort.php'>BACK</a>";
        echo "</div>";
    ...
    <div class="row m-2">
        <div class="alert alert-warning">
            ...
            <form action="delete_cohort.php" method="post">
